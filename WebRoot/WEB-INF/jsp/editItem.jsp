...
<body>
	<form id="itemForm"  onsubmit="return check()"
		action="${pageContext.request.contextPath }/user/saveOrUpdate"
		method="post">
		<input type="hidden" name="iduser" value="${item.iduser }" />
		<h2 class="text-center">Change User Info：</h2>
		
		<div style="width: 40%; margin-left: 30%">
			<div class="form-group">
				<label for="username">User Name</label> <input value="${item.username }"
			...
			<div class="form-group">
				<label for="password">Password</label> <input placeholder="password"
					class="form-control" type="text" name="password" id="password"
					 value="${item.password}" maxlength="20">
			</div>
			<div class="form-group">
				<label for="nickname">Nickname</label> <input placeholder="nickname"
					class="form-control" type="text" name="nickname" id="nickname" value="${item.nickname}" maxlength="20">
			</div>
			<div class="form-group">
				<label for="email">email</label> <input placeholder="email"
					class="form-control" type="text" name="email" id="email" value="${item.email}" maxlength="20">
			</div>
